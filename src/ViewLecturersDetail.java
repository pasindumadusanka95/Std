 ...
 * @author hp
 */
public class ViewLecturersDetail extends javax.swing.JFrame {

    /**
     * Creates new form viewLecturers
     */
    public ViewLecturersDetail() {
        initComponents();
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addComponent(lec, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(173, 173, 173)
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 900, 1300));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String LID = lec.getText();
        String filePath = "D:\\Campus Stuff\\"
                + "Assignment\\src\\ProfilePics\\" + LID + ".png";

        try {
            ResultSet rs = DbHandler.getData("select * from grup_project.lecturers where lecID='" + LID + "'");

            while (rs.next()) {
                jLabel1.setText(rs.getString("lecFName"));
                jLabel5.setText(rs.getString("lecLName"));
                jLabel4.setText(rs.getString("lecEmail"));
                jLabel17.setText(rs.getString("lecgender"));
                jLabel19.setText(rs.getString("lecQualification"));
                jLabel21.setText(rs.getString("lecnic"));
                jLabel22.setText(rs.getString("lecaddress"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewLecturersDetail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewLecturersDetail().setVisible(true);
            }
        });
    }
